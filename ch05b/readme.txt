...
This is PART 2 of the application that uses Asynchronous SQLAlchemy and Peewee ORM.

The ERD design (.png) is in the /database folder of this project. 
No database dump file this time since Peewee ORM requires the schemas 
to be generated at startup.
